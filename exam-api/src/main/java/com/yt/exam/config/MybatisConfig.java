package com.yt.exam.config;

import com.yt.exam.aspect.mybatis.QueryInterceptor;
import com.yt.exam.aspect.mybatis.UpdateInterceptor;
 ...
 */
@Configuration
@MapperScan("com.yt.exam.modules.**.mapper")
