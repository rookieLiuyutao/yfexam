package com.yt.exam.modules.qu.service.impl;
...
import com.yt.exam.modules.qu.dto.QuAnswerDTO;
import com.yt.exam.modules.qu.dto.QuDTO;
import com.yt.exam.modules.qu.dto.export.QuExportDTO;
import com.yt.exam.modules.qu.dto.ext.QuDetailDTO;
import com.yt.exam.modules.qu.dto.request.QuQueryReqDTO;
import com.yt.exam.modules.qu.entity.Qu;
import com.yt.exam.modules.qu.entity.QuAnswer;
import com.yt.exam.modules.qu.entity.QuRepo;
import com.yt.exam.modules.qu.enums.QuType;
import com.yt.exam.modules.qu.mapper.QuMapper;
import com.yt.exam.modules.qu.service.QuAnswerService;
import com.yt.exam.modules.qu.service.QuRepoService;
...
public class QuServiceImpl extends ServiceImpl<QuMapper, Qu> implements QuService {
    ...
    public void checkData(QuDetailDTO qu, String no) {
        ...
        List<QuAnswerDTO> answers = qu.getAnswerList();
            ...
            if (!qu.getQuType().equals(QuType.FULL)&&trueCount == 0) {
